...
Globals:
  Function:
    Timeout: 3 # Sets the maximum execution time for Lambda functions to seconds.
            ...
            Statement: # Define the statements in the policy
              ...
              - Effect: Allow
                Action:
                  ...
                  # PLEASE ADD POLLY AND S3 PERMISSIONS HERE
                Resource: "*"
...
export default TemplateCodePollyS3;
