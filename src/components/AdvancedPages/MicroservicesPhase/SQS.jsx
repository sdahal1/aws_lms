...
const SQS = () => {
  return (
    <div>
      ...
      <NavigationButtons previousPath="/advanced/phase1:-monolith/improvements-and-challenges" nextPath="/advanced/phase2:-scalable-and-asynchronous/updating-our-application-to-use-sqs" />
    </div>
  )
}
