...
const UpdateAPP = () => {
  return (
    <div>
      ...
      <NavigationButtons previousPath='/advanced/phase2:-scalable-and-asynchronous/simple-queue-service-(sqs)' nextPath='/advanced/phase2:-scalable-and-asynchronous/improvements-and-challenges' />
    </div>
  )
}
