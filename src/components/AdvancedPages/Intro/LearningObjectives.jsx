...
Learn how to deploy and test serverless applications using AWS Management Console or AWS CLI. */}
      ...
      <div className='d-flex m-2 justify-content-end align-items-center'>
        ...
        <div>
          <Link to="/advanced/introduction-and-prerequisites/architecture-overview" className="btn btn-primary">Previous</Link>
        </div>
        <div>
          <Link to="/advanced/introduction-and-prerequisites/prerequisites" className="btn btn-warning m-2">Next</Link>
        </div>
      </div>
    </div>
  )
