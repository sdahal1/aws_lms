  ...
  return (
    <div>
      ...
      <div className='d-flex m-2 justify-content-end align-items-center'>
        ...
        <div>
          <Link to="/advanced/introduction-and-prerequisites/real-world-scenario" className="btn btn-primary">Previous</Link>
        </div>
        <div>
          <Link to="/advanced/introduction-and-prerequisites/learning-objectives" className="btn btn-warning m-2">Next</Link>
        </div>
      </div>
    </div>
  )
