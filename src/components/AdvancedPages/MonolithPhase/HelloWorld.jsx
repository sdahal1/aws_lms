  ...
  return (
    <div>
      ...
      <section>
        ...
        <CodeBlock
          text={`curl https://your-api-id.execute-api.us-west-2.amazonaws.com/Prod/hello`}
          language='bash'
          showLineNumbers={true}
          theme={'atom-one-light'}
        />
      ...
      {/* <div className='d-flex m-2 justify-content-end align-items-center'>
        <div>
          <Link to="/basic/setup/email-verification-in-ses" className="btn btn-primary">Previous</Link>
        </div>
        <div>
          <Link to="/basic/phase1:-monolith/create-new-user" className="btn btn-warning m-2">Next</Link>
        </div>
      </div> */}
      <NavigationButtons previousPath="/advanced/setup/email-verification-in-ses" nextPath="/advanced/phase1:-monolith/create-new-user" />
    </div>
  )
}
