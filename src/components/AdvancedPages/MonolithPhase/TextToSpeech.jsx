  ...
  return (
    <div>
      ...
      <section>
        ...
        <LambdaCode3PollyS3/>
        <p>NOTE: You're in advanced mode, so you will have to complete the synthesize_message function. We have provided comments to help guide you.</p>
      </section>
      <section>
      ...
      <NavigationButtons previousPath="/advanced/phase1:-monolith/translation-of-messages" nextPath="/advanced/phase1:-monolith/send-email" />
    </div>
  )
}
