    ...
    <div>
      ...
      <section>
        ...
        <ol>
          ...
          <LambdaCode1 />
          <p>Note: Please fill out the code for inserting the user information into the DB, you can write where it says: "# ADVANCED CHALLENGE: PLEASE INSERT THE ITEM TO THE TABLE HERE"</p>
        </ol>
      </section>
      <section>
        ...
        <div className='advanced'>
          <h3>
            PLEASE WRITE UP THIS ARCHITECTURE IN YOUR SAM TEMPLATE!!
          </h3>
      ...
      <NavigationButtons previousPath="/advanced/phase1:-monolith/create-hello-world-with-sam" nextPath="/advanced/phase1:-monolith/translation-of-messages" />
    </div>
  )
}
