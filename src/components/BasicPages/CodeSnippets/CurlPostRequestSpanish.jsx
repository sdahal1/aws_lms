...
const CurlPostRequestSpanish = () => {
  const codeString = `
curl -X POST https://pf1q7jrbq2.execute-api.us-west-2.amazonaws.com/Prod/subscribe/ \ \n
-H "Content-Type: application/json" \ \n
-d '{"fullName": "Rob Dahal", "email": "sdahal1@yahoo.com", "phone": "1234567890", "state": "California", "county": "Santa Clara", "preferredLanguage": "es"}'
`;
...
export default CurlPostRequestSpanish;
