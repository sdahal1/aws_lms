...
const MicroImprovements = () => {
  return (
    <div>
      ...
      <NavigationButtons previousPath="/basic/phase2:-scalable-and-asynchronous/updating-our-application-to-use-sqs" nextPath="/basic/phase2:-scalable-and-asynchronous/mass-alert" />
    </div>
  )
}
