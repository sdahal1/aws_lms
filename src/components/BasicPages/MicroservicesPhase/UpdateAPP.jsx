...
const UpdateAPP = () => {
  return (
    <div>
      ...
      <NavigationButtons previousPath='/basic/phase2:-scalable-and-asynchronous/simple-queue-service-(sqs)' nextPath='/basic/phase2:-scalable-and-asynchronous/improvements-and-challenges' />
    </div>
  )
}
