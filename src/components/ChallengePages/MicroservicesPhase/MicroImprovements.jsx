...
const MicroImprovements = () => {
  return (
    <div>
      ...
      <NavigationButtons previousPath="/challenge/phase2:-scalable-and-asynchronous/updating-our-application-to-use-sqs" nextPath="/challenge/phase2:-scalable-and-asynchronous/mass-alert" />
    </div>
  )
}
