...
const SQS = () => {
  return (
    <div>
      ...
      <NavigationButtons previousPath="/challenge/phase1:-monolith/improvements-and-challenges" nextPath="/challenge/phase2:-scalable-and-asynchronous/updating-our-application-to-use-sqs" />
    </div>
  )
}
