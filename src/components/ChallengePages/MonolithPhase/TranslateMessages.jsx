  ...
  return (
    <div>
      ...
      <section>
        ...
        <h3>Do you not see that response? Did something go wrong?</h3>
        <BugAlert answers={["Check the lambda function's helper 'translate_message' function. For the SourceLanguageCode, it has an invalid value. What would be an appropriate value for this?"]}/>
      </section>
      <section>
      ...
      <NavigationButtons previousPath="/challenge/phase1:-monolith/create-new-user" nextPath="/challenge/phase1:-monolith/text-to-speech" />
    </div>
  )
}
