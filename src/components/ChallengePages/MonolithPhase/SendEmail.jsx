  ...
  return (
    <div>
      ...
      <section>
        ...
        <BugAlert answers={["Check the YAML file, for lambda function timeout is 2 seconds. You will need to increase this. Check cloudwatch logs to see how long function took. Change the function timeout in the YAML file to 5 seconds."]}/>
      </section>
      <section>
        <h3>WARNING:</h3>
      ...
      <NavigationButtons previousPath="/challenge/phase1:-monolith/text-to-speech" nextPath="/challenge/phase1:-monolith/improvements-and-challenges" />
    </div>
